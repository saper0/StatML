...
# Author: Lukas Gosch
# Date: 28.10.2018
# Description: Implementation of a linear SVM for the wine dataset 
...
#			   Solving Soft-SVM. Extention to multi-class prediction is 
#			   done via the one-versus-all approach. 
#######################################################################
...
def evalLearning(h_l, eval_l, lmbda, T, X, Y):
...
obj_vals, dists_opt = evalLearning(h_l, eval_l, lmbda, T, X, Y)
